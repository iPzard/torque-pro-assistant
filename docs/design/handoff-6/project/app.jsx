...
function App() {
  ...
  const navItems = [
    ...
    ...(sessions.length >= 2 ? [{ route: { name: "compare", ids: [sessions[0].meta.id, sessions[1].meta.id] }, icon: I.compare, label: "Compare", badge: "2" }] : [{ route: null, icon: I.compare, label: "Compare", disabled: true, badge: "—" }]),
    ...
    <div className={"app-shell" + (bannerVisible ? " has-banner" : "")}>
      ...
      <div className="app-titlebar">
        ...
        {t.vehicleConnected
          ...
          : <span className="pill warn"><i className="dot"/>No vehicle selected</span>}
